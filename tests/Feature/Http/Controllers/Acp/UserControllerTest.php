...
/**
 * @see \App\Http\Controllers\Acp\UserController
 */
class UserControllerTest extends TestCase
{
    ...
    public function store_uses_form_request_validation()
    {
        $this->assertActionUsesFormRequest(
            \App\Http\Controllers\Acp\UserController::class,
            'store',
            \App\Http\Requests\Acp\UserStoreRequest::class
        );
    }
    ...
    public function update_uses_form_request_validation()
    {
        $this->assertActionUsesFormRequest(
            \App\Http\Controllers\Acp\UserController::class,
            'update',
            \App\Http\Requests\Acp\UserUpdateRequest::class
        );
    }
