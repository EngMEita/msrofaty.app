...
/**
 * @see \App\Http\Controllers\Acp\CategoryController
 */
class CategoryControllerTest extends TestCase
{
    ...
    public function store_uses_form_request_validation()
    {
        $this->assertActionUsesFormRequest(
            \App\Http\Controllers\Acp\CategoryController::class,
            'store',
            \App\Http\Requests\Acp\CategoryStoreRequest::class
        );
    }
    ...
    public function update_uses_form_request_validation()
    {
        $this->assertActionUsesFormRequest(
            \App\Http\Controllers\Acp\CategoryController::class,
            'update',
            \App\Http\Requests\Acp\CategoryUpdateRequest::class
        );
    }
