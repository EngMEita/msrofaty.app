<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('acp.dashboard')" :active="request()->routeIs('acp.dashboard')">
                الرئيسية
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('acp.account.index')" :active="request()->routeIs('acp.account.index')">
                الحسابات
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('acp.category.index')" :active="request()->routeIs('acp.category.index')">
                التصنيفات
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('acp.budget.index')" :active="request()->routeIs('acp.budget.index')">
                الميزانيات
            </x-responsive-nav-link>
        </div>
