...
تطبيق ويب متقدم لإدارة المصروفات الشخصية والميزانيات، مبني بـ **Laravel 10 (LTS)**.
...
| المعيار          | القيمة                   |
| ---------------- | ------------------------ |
| **Laravel**      | 10.x (LTS - دعم 3 سنوات) |
| **PHP**          | 8.1+                     |
| **MySQL/SQLite** | 5.7+ / 3.25+             |
| **Node.js**      | 18+ (اختياري)            |

**تم الترقية من Laravel 8 إلى Laravel 10 بتاريخ 18 أغسطس 2026** - [اقرأ دليل الترقية](UPGRADE_GUIDE.md)
...
- **PHP 8.1+** (محدّث)
- **Composer** 2.0+
- **Node.js** 18+ و npm 9+ (اختياري)
- **MySQL** 5.7+ أو **SQLite** 3.25+
- **Laravel** 10.0+
